...
SortState g_Sort;
const char* LOAD_PATH = "unsorted_scores.txt"; // The source file
const char* SAVE_PATH = "sorted_scores.txt";   // The output file
...
int main() {
	...
	while (!glfwWindowShouldClose(window)) {
		...
		// --- GUI RENDER ---
		{
			...
			ImGui::SameLine();
			if (ImGui::Button("Load from File")) LoadFromFile(LOAD_PATH);
